...
This is just a :doc:`convention that we follow through the code base <contributing>`, which slightly simplifies what we need to parse in our various build systems.
